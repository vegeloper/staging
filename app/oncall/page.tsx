...
export const tripFaqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "در سرویس در اختیار، مقصد مشخصی هنگام ثبت درخواست تعیین نمی‌شود. خودرو در بازه زمانی انتخاب‌شده در اختیار شماست و می‌توانید سفر‌های موردنیاز خود را در طول مدت سرویس انجام دهید.",
  },
  {
